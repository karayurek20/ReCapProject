...
namespace Business.Concrete
{
    public class CustomerMenager : ICustomerService
    {
        ...
        {
            return new SuccessDataResult<List<Customer>>(_customerDal.GetAll(),Messages.DataResultListMessage);
        }

        public IDataResult<Customer> GetById(int id)
        {
            return new SuccessDataResult<Customer>(_customerDal.Get(c => c.Id == id), Messages.DataResultListMessage);
        }
